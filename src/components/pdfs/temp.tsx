        ...
        <Page size={"A4"} style={styles.page}>
          ...
          <View style={aclarationsStyles.section}>
            ...
            <View style={aclarationsStyles.box}>
              ...
              <Text style={aclarationsStyles.text}>
                Tiempo de entrega: "El plazo estimado de entrega es de [X] días
                hábiles desde la confirmación del pago."
              </Text>
              <Text style={aclarationsStyles.text}>
                Costos de envío: "El envío dentro de [zona] es sin cargo. Para
                otras localidades, consulte costos adicionales."
              </Text>
              <Text style={aclarationsStyles.text}>
                Garantía: "Todos nuestros productos/servicios cuentan con una
                garantía de [X] meses/años contra defectos de fabricación."
              </Text>
              <Text style={aclarationsStyles.text}>
                Seña o anticipo: "Para confirmar el pedido, se requiere un
                anticipo del [X]%. El saldo se abonará antes de la entrega."
              </Text>
            </View>
          </View>
